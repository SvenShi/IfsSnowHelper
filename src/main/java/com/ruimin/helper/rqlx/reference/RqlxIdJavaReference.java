package com.ruimin.helper.rqlx.reference;
 ...
 * @description
 */
public class RqlxIdJavaReference extends PsiReferenceBase<XmlAttributeValue> implements PsiPolyVariantReference {
     ...
     */
    public RqlxIdJavaReference(@NotNull XmlAttributeValue element) {
