 ...
 * @description
 */
public class SnowPageDataSetPathReference extends PsiReferenceBase<XmlAttributeValue> implements
     ...
     */
    public SnowPageDataSetPathReference(@NotNull XmlAttributeValue element) {
    ...
    public ResolveResult @NotNull [] multiResolve(boolean incompleteCode) {
        ...
        if (module != null) {
            ...
            List<XmlFile> dtst = DtstUtils.findDtstFileByPath(path, module.getModuleScope());
