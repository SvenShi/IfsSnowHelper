 ...
 * @description
 */
public class ButtonIdReference extends PsiReferenceBase<XmlAttributeValue> implements PsiPolyVariantReference {
     ...
     */
    public ButtonIdReference(@NotNull XmlAttributeValue element, String buttonId, TextRange range) {
