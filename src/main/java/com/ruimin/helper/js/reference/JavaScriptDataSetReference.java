 ...
 * @description
 */
public class JavaScriptDataSetReference extends PsiReferenceBase<JSReferenceExpression> implements
     ...
     */
    public JavaScriptDataSetReference(@NotNull JSReferenceExpression element) {
